...
GROUP_INFO = {
    1: {
        ...
        # foods_out: 外食時の提案（ガッツリ外食系）
        'foods_out': ['こってりラーメン', '焼肉', 'トンカツ', '牛丼'],
        # foods_in: 自炊時の提案
        'foods_in':  ['唐揚げ定食', '牛丼', '生姜焼き', 'ハンバーグ'],
    },
    2: {
        'name': 'ご褒美モード',
        'emoji': '🎉',
        ...
        'foods_out': ['寿司', 'ステーキ', 'うなぎ', 'しゃぶしゃぶ'],
        'foods_in':  ['刺身定食', '鶏の照り焼き', 'ハンバーグ', 'パスタ'],
    },
    3: {
        'name': '癒しが欲しい',
        'emoji': '🍵',
        ...
        'foods_out': ['おでん', '鍋', 'うどん', 'そば'],
        'foods_in':  ['茶碗蒸し', '雑炊', '鍋', 'うどん'],
    },
    4: {
        'name': '健康意識モード',
        'emoji': '🥗',
        ...
        'foods_out': ['和定食', '刺身定食', 'そば', 'うどん'],
        'foods_in':  ['サラダチキン', '野菜炒め', '焼き魚', '和定食'],
    },
    5: {
        'name': '省エネモード',
        'emoji': '😴',
        ...
        'foods_out': ['そば', 'うどん', '牛丼', 'おにぎり'],
        'foods_in':  ['お茶漬け', 'おにぎり', '雑炊', '卵かけご飯'],
    },
    6: {
        'name': '発散したい',
        'emoji': '🌶️',
        ...
        'foods_out': ['激辛ラーメン', 'タイ料理', 'インドカレー', '焼肉'],
        'foods_in':  ['豚キムチ', '麻婆豆腐', 'ビビンバ', 'プルコギ'],
    },
    7: {
        'name': '社交モード',
        'emoji': '🍻',
        ...
        'foods_out': ['居酒屋系', 'たこ焼き', 'しゃぶしゃぶ', '焼き鳥'],
        'foods_in':  ['鍋', '焼き鳥', 'パスタ', 'ハンバーグ'],
    },
    8: {
        'name': 'しんみりモード',
        'emoji': '🥹',
        ...
        'foods_out': ['うどん', 'そば', 'おでん', '和定食'],
        'foods_in':  ['肉じゃが', '親子丼', '味噌汁定食', '卵かけご飯'],
    },
    9: {
        'name': 'チャレンジャー',
        'emoji': '🌍',
        ...
        'foods_out': ['エスニック料理', 'イタリアン', 'タイ料理', 'インドカレー'],
        'foods_in':  ['パスタ', 'カレー', 'ビビンバ', 'プルコギ'],
    },
    10: {
        'name': '普通の日',
        'emoji': '🍽️',
        ...
        'foods_out': ['牛丼', '焼き鳥', 'ハンバーグ', 'カレー'],
        'foods_in':  ['カレー', 'ハンバーグ', '生姜焼き', 'パスタ'],
    },
}
...
def food_to_group(food_name):
    ...
    GROUP_INFO の各グループの foods_out・foods_in リストを検索し、
    ...
    for group_id, info in GROUP_INFO.items():
        all_foods = info.get('foods_out', []) + info.get('foods_in', [])
